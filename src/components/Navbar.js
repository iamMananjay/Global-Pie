...
//     return (
//         <nav className="fixed top-0 left-0 w-full bg-black p-4 z-10 flex justify-between items-center">
//             {/* Logo */}
//             <RouterLink
//                 to="/"
...
//                 className={`${
//                     menuActive
//                         ? 'flex flex-col absolute top-20 left-0 w-full bg-black p-4 z-20'
//                         : 'hidden'
...
//                             smooth={true}
//                             duration={500}
//                             className="text-white text-lg hover:bg-gray-600 p-2 rounded-md cursor-pointer"
//                         >
//                             Home
//                         </Link>
//                     ) : (
...
//                         to="/products"
//                         className="text-white text-lg hover:bg-gray-600 p-2 rounded-md cursor-pointer"
//                         onClick={() => window.scrollTo(0, 0)} // Ensure scrolling to top for /products
//                     >
//                         Products
//                     </RouterLink>
//                 </li>
