...
//                     <h2 className="text-2xl font-bold mb-2">Global Pie Import & Export Ltd.</h2>
//                     <p className="text-sm">
//                         Suite 7, Ealing House, 33 Hanger Lane, London, W5 3HJ
//                     </p>
//                     <p className="text-sm">Telephone: 02034411068 | Mobile: 07879403572</p>
//                     <p className="text-sm">Email: <a href="mailto:globalpie2024@gmail.com" className="text-purple-500 hover:underline">globalpie2024@gmail.com</a></p>
//                     <p className="text-sm">Website: <a href="https://www.globalpieimportexport.com" target="_blank" rel="noopener noreferrer" className="text-purple-500 hover:underline">www.globalpieimportexport.com</a></p>
//                 </div>

//                 {/* Social Media Icons */}
//                 <div className="flex justify-center gap-6 mb-8">
//                     <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-500 transition duration-300">
//                         <i className="fab fa-facebook-f text-2xl"></i>
//                     </a>
//                     <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-500 transition duration-300">
//                         <i className="fab fa-twitter text-2xl"></i>
//                     </a>
//                     <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-500 transition duration-300">
//                         <i className="fab fa-linkedin-in text-2xl"></i>
//                     </a>
//                     <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-purple-500 transition duration-300">
...
//                     <a href="/about" className="text-white hover:text-purple-500 transition duration-300">About Us</a>
//                 </div>
...
//                     </p>
//                     <p className="text-xs">
//                         Designed and Developed by <a href="https://yourwebdeveloper.com" target="_blank" rel="noopener noreferrer" className="text-purple-500 hover:underline">Your Web Developer</a>
//                     </p>
//                 </div>
//             </div>
//         </footer>
